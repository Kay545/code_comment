...
def process_wandb_config_ddp_mode(opt):  
    ...
    if isinstance(data_dict['train'], str) and data_dict['train'].startswith(WANDB_ARTIFACT_PREFIX): # 加载训练集
        api = wandb.Api()
    ...
    if isinstance(data_dict['val'], str) and data_dict['val'].startswith(WANDB_ARTIFACT_PREFIX): # 加载验证集
        api = wandb.Api()
